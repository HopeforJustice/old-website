        ...
        */
        ...
        if (newIndex < currentIndex && newIndex == 0) {
                ...
                $("#donate-uk__msgp").fadeOut(100, function(){
                    $(this).html("Your gift can change lives and end slavery.<br><br><strong class=\"donate-uk__orange\">£25</strong> – Could provide meals for a week for a child at one of our Lighthouses as they are protected from exploitation<br><br><strong class=\"donate-uk__orange\">£50</strong> – Could provide emergency shelter and care for a vulnerable child for one month<br><br><strong class=\"donate-uk__orange\">£5,000</strong> – Could enable our team to run an entire investigative operation to identify and rescue a child or adult from modern slavery.").fadeIn(500);
                });
                ...
                $(".donate-uk").removeClass("donate-uk__background--cover");
                $(".donate-uk__wrapper").removeClass("donate-uk__wrapper--padding");
                $(".wizard>.actions>ul").css("justify-content", "space-around");
