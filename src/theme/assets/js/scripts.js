...
jQuery(document).ready(function($) {
    ...
    //raise-a-glass copy prices to gravity forms
    $('.rag-prices__button').click(function(){
    ...
    //raise-a-glass copy custom amount to gravity forms
    $('.rag-prices__custom').click(function(){
        var value = $(this).find('input').val();
        $('.ginput_amount').val(value);
        $('#textAmount').text(value);
    });

    $('#ragInput').keyup(function(e){
        if(e.keyCode == 13)
        {
    ...
    //raise-a-glass input value to buttonn
    $('#ragInput').on('input', function() {
        var value = $(this).val();
        if (value !== '') {
            $('#ragButton').html('Donate $' + value);
        } else {
            $('#ragButton').html('Custom amount');
        }
    });
    ...
    $("#goCardless").click(function(){
        ...
        window.location.href = link + 'Amount=' + $("#Amount").val() + vars.trim();
    });
