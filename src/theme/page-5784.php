<?php
/**
 * The template used for /yir19/ desktop
 *
...
<?php
	...
	if($userInfo && in_array($userInfo, $us_donate)){
	    $url .= 'http://hopeforjustice.org/wp-content/uploads/2019/09/Year-in-Review-2018-19-desktop-optimised.USA_.pdf';
	}else {
		$url .= 'http://hopeforjustice.org/wp-content/uploads/2019/08/Year-in-Review-2018-19-desktop-optimised.pdf';
	}
	//echo $url;
	wp_redirect($url);
	exit;
