<?php
/**
 * The template used for guardian mug campaign with UTM tracking ONE OFF
 *
...
<?php
	...
	if($userInfo && in_array($userInfo, $us_donate)){
	    $url .= '/donate/us/?donate_campaign=September%20Guardian%20-%20Free%20Mug?utm_source=Postcard&utm_medium=Print&utm_campaign=USGuardian';
	} else{
